...
contract Trump{
    ...
    function setFirstWinner(address[] _firstWinner, uint _turn) public onlyOwner {
        uint t = turn;
        if(_turn > 0){
            t = _turn;
        }
    ...
    function setSecondWinner(address[] _secondWinner, uint _turn) public onlyOwner {
        uint t = turn;
        if(_turn > 0){
            t = _turn;
        }
    ...
    function setThirdWinner(address[] _thirdWinner, uint _turn) public onlyOwner {
        uint t = turn;
        if(_turn > 0){
            t = _turn;
        }
